...
run `ruby scripts/aspsx-oracle.rb --aspsx <ASPSX.EXE> --only 'test/fixtures/probes/VERIFY-n.s'`,
which assembles the probe with the real ASPSX 2.81 under wine and writes
